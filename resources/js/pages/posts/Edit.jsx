...
const PostsEdit = ({ post }) => {
  ...
  const translationData = {
    fr: {
      title: post.translations?.find(t => t.locale === 'fr')?.title || '',
      excerpt: post.translations?.find(t => t.locale === 'fr')?.excerpt || '',
      content: post.translations?.find(t => t.locale === 'fr')?.content || ''
    },
    sr: {
      title: post.translations?.find(t => t.locale === 'sr')?.title || '',
      excerpt: post.translations?.find(t => t.locale === 'sr')?.excerpt || '',
      content: post.translations?.find(t => t.locale === 'sr')?.content || ''
    }
  }
